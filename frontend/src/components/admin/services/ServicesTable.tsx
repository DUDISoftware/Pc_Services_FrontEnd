...
export default function ServicesTable() {
    ...
    // useEffect(() => {
    //     console.log('Service list updated:', services);
    // }, [services]);
                        ...
                        return (
                            <tr key={s._id} className="border-b hover:bg-gray-50">
                                ...
                                <td className="p-2 text-center">
                                    {(() => {
                                        const sale_off = s.discount;
                                        const dates = s.start_date && s.end_date ? { start: s.start_date, end: s.end_date } : undefined;
                                        ...
                                        if (isActive) {
                                            return <span className="text-green-600 font-medium">{sale_off}% đang diễn ra</span>;
                                        } else if (isUpcoming) {
                                            return <span className="text-yellow-500 italic">{sale_off}% sắp diễn ra</span>;
                                        } else {
                                            return <span className="text-gray-400">{sale_off}% kết thúc</span>;
                                        }
                                    })()}
                                </td>
                                <td className="p-2 text-center">
            ...
            <div className="lg:hidden space-y-4 mt-4">
                {displayedServices.map((s) => (
                    <div key={s._id} className="border rounded p-4 shadow-sm">
                        ...
                        <p><strong>Danh mục:</strong> {typeof s.category === "object" ? s.category.name : "Chưa có"}</p>
